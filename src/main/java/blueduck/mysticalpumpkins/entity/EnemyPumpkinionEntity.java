...
public class EnemyPumpkinionEntity extends MonsterEntity implements IAnimatable {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(
				new AnimationController<EnemyPumpkinionEntity>(this, "controller", 0.1F, this::predicate));
	}
