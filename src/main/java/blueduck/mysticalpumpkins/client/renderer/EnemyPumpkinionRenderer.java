...
public class EnemyPumpkinionRenderer extends GeoEntityRenderer<EnemyPumpkinionEntity> {

	public EnemyPumpkinionRenderer(EntityRendererManager renderManagerIn) {
		super(renderManagerIn, new PumpkinionModel());
	}

	@Override
	public RenderType getRenderType(EnemyPumpkinionEntity animatable, float partialTicks, MatrixStack stack,
